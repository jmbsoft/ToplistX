...
Please select your rating for this site from the drop down selection field listed below.   To add comments about
this site, please fill in the e-mail, name, and comments fields as well.  If you would rather not add any comments,
...
<input type="hidden" name="r" value="dorateandcomment" />
</form>
