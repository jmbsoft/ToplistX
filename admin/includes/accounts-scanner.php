...
function deleteSelected(id)
{
    ...
    {
        infoBarAjax({data: 'r=tlxScannerConfigDelete&' + selected.serialize()});
    }
...
function scannerAction(action, id)
{
    ...
    {
        var func = (action == 'start' ? 'tlxScannerStart' : 'tlxScannerStop');
  ...
  <div id="centered-content" class="max-width">
    <div class="heading">
      <div class="heading-icon">
        <a href="index.php?r=tlxShScannerConfigAdd" class="window {title: 'Add Scanner Configuration'}">
      ...
      Account Scanner Configurations
    </div>



    <form action="ajax.php" name="search" id="search" method="POST">
    <input type="hidden" name="r" value="tlxScannerConfigSearch">
      ...
      <thead>
        ...
        <tr id="_none_" style="display: none;">
          <td colspan="7" class="last warn">
            No account scanner configurations have been created
          </td>
        </tr>
