...
function deleteSelected(id)
{
    ...
    {
        infoBarAjax({data: 'r=tlxPageDelete&' + selected.serialize()});
    }
  ...
  <div id="centered-content" class="max-width">
    <div class="heading">
      <div class="heading-icon">
        <a href="index.php?r=tlxShPageAddBulk" class="window {title: 'Bulk Add Ranking Pages', height: '425'}">
        <img src="images/add-bulk.png" border="0" alt="Bulk Add Ranking Pages" title="Bulk Add Ranking Pages"></a>
        &nbsp;
        <a href="index.php?r=tlxShPageAdd" class="window {title: 'Add Ranking Page', height: '375'}">
        <img src="images/add.png" border="0" alt="Add TGP Page" title="Add Ranking Page"></a>
        &nbsp;
        <a href="docs/pages-manage.html" target="_blank"><img src="images/help.png" border="0" alt="Help" title="Help"></a>
      </div>
      Manage Ranking Pages
    </div>
    ...
    <input type="hidden" name="r" value="tlxPageSearch">
