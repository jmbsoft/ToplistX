  ...
  <div id="centered-content" class="max-width">
    <div class="heading">
      <div class="heading-icon">
        <a href="docs/accounts-scanner-history.html" target="_blank"><img src="images/help.png" border="0" alt="Help" title="Help"></a>
      </div>
      Account Scanner History
    </div>
    ...
    <input type="hidden" name="r" value="tlxScannerHistorySearch">
