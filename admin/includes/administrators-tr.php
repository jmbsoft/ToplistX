<tr id="<?php echo $item['username']; ?>">
  ...
  <td style="text-align: right;" class="last">
    <a href="index.php?r=tlxShAdministratorEdit&username=<?php echo urlencode($item['username']); ?>" class="window function {title: 'Edit Administrator'}">
    <img src="images/edit.png" width="12" height="12" alt="Edit" title="Edit"></a>
    <a href="index.php?r=tlxShAdministratorMail&username[]=<?php echo urlencode($item['username']); ?>" class="window function {title: 'E-mail Administrator'}">
