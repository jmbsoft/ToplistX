...
function mailSelected()
{
    ...
    return {href: 'index.php?&r=tlxShAdministratorMail&' + selected.serialize()};
}
...
function deleteSelected(id)
{
    ...
    {
        infoBarAjax({data: 'r=tlxAdministratorDelete&' + selected.serialize()});
    }
  ...
  <div id="centered-content" class="max-width">
    <div class="heading">
      <div class="heading-icon">
        <a href="index.php?r=tlxShAdministratorAdd" class="window {title: 'Add Administrator'}">
    ...
    <input type="hidden" name="r" value="tlxAdministratorSearch">
