...
function deleteSelected(id)
{
    ...
    {
        infoBarAjax({data: 'r=tlxIconDelete&' + selected.serialize()});
    }
  ...
  <div id="centered-content" class="max-width">
    <div class="heading">
      <div class="heading-icon">
        <a href="index.php?r=tlxShIconAdd" class="window {title: 'Add Icon'}">
        <img src="images/add.png" border="0" alt="Add Icon" title="Add Icon"></a>
        &nbsp;
    ...
    <input type="hidden" name="r" value="tlxIconSearch">
