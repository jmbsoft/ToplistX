...
function deleteSelected(id)
{
    ...
    {
        infoBarAjax({data: 'r=tlxAccountFieldDelete&' + selected.serialize()});
    }
  ...
  <div id="centered-content" class="max-width">
    ...
    <div class="heading margin-bottom">
      <div class="heading-icon">
        <a href="index.php?r=tlxShAccountFieldAdd" class="window {title: 'Add Account Field'}"><img src="images/add.png" border="0" alt="Add Account Field" title="Add Account Field"></a>
        &nbsp;
    ...
    <input type="hidden" name="r" value="tlxAccountFieldSearch">
